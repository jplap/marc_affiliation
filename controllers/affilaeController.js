...
conversionsListCaller = function( programId, limit ){
        ...
        try {
            ...
            request.get(url, {
                ...
                if (error) {
                    ...
                    conversionsListWithLimitCaller(programId, response.body ).then((resp) => {
                        resolve(resp);
                    }, function (erreur) {
                        reject(erreur);
                    })
...
conversionsListWithLimitCaller = function( programId, limit ){
...
conversionsByIdCaller = function( programId, id ){
    return new Promise( ( resolve, reject ) => {
        try {
            var username = AFFILAE_USER;
            var password = AFFILAE_PWD;
...
addConversionCaller = function( programId, id, partnership_id, amount, commission, rule_Id ){
    return new Promise( ( resolve, reject ) => {
        try {
            var username = AFFILAE_USER;
            var password = AFFILAE_PWD;
